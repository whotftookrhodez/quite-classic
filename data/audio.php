...
$item = $slugLower && isset($audioDataLower[$slugLower]) ? [$audioDataLower[$slugLower]] : $audioDataLower;
...
<head>
    ...
    <title><?= $slug ? h($item[$slugLower]['title']) . ' – quite classic' : 'quite classic' ?></title>
    <link rel="stylesheet" href="/styles.css">

    <?php if ($slug && isset($item[$slugLower])): ?>
        <meta property="og:image" content="https://quiteclassic.org<?= h($item[$slugLower]['cover']) ?>">
        <meta property="og:title" content="<?= h($item[$slugLower]['title']) ?>">
